...
*
*<blockquote><pre>{@code
*Néhány működést bemutató kódcsipet :
*
*Példányosítjuk a GameManager osztályt a metódusok bemutatásához.
*GameManager gameManager = new GameManager();
*
*Beállíthatjuk az aktuális játékost.
*gameManager.setCurrentUser("Béla",0);
*
*És lekérdezhetjük.
*gameManager.getCurrentUser();
*
*Ez a metódus visszaadja , hogy mi lett volna a helyes válasz amikor rosszat választunk.
*gameManager.getRightAnswerWhenLoose();}</pre></blockquote>
*
*
*/
